...
<head>
    ...
    <!-- fonts -->
    <link rel="stylesheet" href="{{ asset('/fonts/MyFontsWebfontsKit.css') }}">


    <!-- main_css -->
    <link rel="stylesheet" href="{{ asset('css/lib/animation_big.css') }}">
    <link rel="stylesheet" href="{{ asset('css/lib/jquery.fancybox.css') }}">
    <link rel="stylesheet" href="{{ asset('css/lib/nice-select.css') }}">
    <link rel="stylesheet" href="{{ asset('css/lib/swiper-bundle.css') }}">
...
<div id="wrapper" class="wrapper site__wrapper">
                    ...
                    <div class="list__catalog list__catalog-js">
                        <div class="wrap__list">
                            <a href="#" class="item__list">
                                <span class="img__item">
                                    <img src="{{ asset('images/dest/dropdown_cat_img_mp/ph1.jpg') }}" alt="">
                                </span>
                                <span class="text__item">Сварочные материалы</span>
                            </a>
                            <a href="#" class="item__list">
                            <span class="img__item">
                                <img src="{{ asset('images/dest/dropdown_cat_img_mp/ph2.jpg') }}" alt="">
                            </span>
                                <span class="text__item">Гвозди</span>
                            </a>
                            <a href="#" class="item__list">
                            <span class="img__item">
                                <img src="{{ asset('images/dest/dropdown_cat_img_mp/ph3.jpg') }}" alt="">
                            </span>
                                <span class="text__item">Поликарбонат</span>
                            </a>
                            <a href="#" class="item__list">
                            <span class="img__item">
                                <img src="{{ asset('images/dest/dropdown_cat_img_mp/ph4.jpg') }}" alt="">
                            </span>
                                <span class="text__item">Сетка сварная</span>
                            </a>
                            <a href="#" class="item__list">
                            <span class="img__item">
                                <img src="{{ asset('images/dest/dropdown_cat_img_mp/ph5.jpg') }}" alt="">
                            </span>
                                <span class="text__item">Сетка тканая</span>
                            </a>
                            <a href="#" class="item__list">
                            <span class="img__item">
                                <img src="{{ asset('images/dest/dropdown_cat_img_mp/ph6.jpg') }}" alt="">
                            </span>
                                <span class="text__item">Сетка рабица</span>
                            </a>
                            <a href="#" class="item__list">
                            <span class="img__item">
                                <img src="{{ asset('images/dest/dropdown_cat_img_mp/ph7.jpg') }}" alt="">
                            </span>
                                <span class="text__item">Материалы для увязки</span>
                            </a>
                            <a href="#" class="item__list">
                            <span class="img__item">
                                <img src="{{ asset('images/dest/dropdown_cat_img_mp/ph8.jpg') }}" alt="">
                            </span>
                                <span class="text__item">Столбы заборные</span>
                            </a>
                            <a href="#" class="item__list">
                            <span class="img__item">
                                <img src="{{ asset('images/dest/dropdown_cat_img_mp/ph9.jpg') }}" alt="">
                            </span>
                                <span class="text__item">Заборные секции</span>
                            </a>
                            <a href="#" class="item__list">
                            <span class="img__item">
                                <img src="{{ asset('images/dest/dropdown_cat_img_mp/ph10.jpg') }}" alt="">
                            </span>
                                <span class="text__item">Газонные ограждения</span>
                            </a>
                            <a href="#" class="item__list">
                            <span class="img__item">
                                <img src="{{ asset('images/dest/dropdown_cat_img_mp/ph11.jpg') }}" alt="">
                            </span>
                                <span class="text__item">Охранные ограждения</span>
                            </a>
                            <a href="#" class="item__list">
                            <span class="img__item">
                                <img src="{{ asset('images/dest/dropdown_cat_img_mp/ph12.jpg') }}" alt="">
                            </span>
                                <span class="text__item">Ворота и калитки</span>
                            </a>
                            <a href="#" class="item__list">
                            <span class="img__item">
                                <img src="{{ asset('images/dest/dropdown_cat_img_mp/ph13.jpg') }}" alt="">
                            </span>
    ...
    <main id="main" class="main main-js">
        @include('includes.users_info', ['usersInfo' =>$usersInfo])
            ...
            <div class="inner">
                ...
                <div class="catalog__category">
                    <a href="#" class="item__catalog">
                        <h3 class="title__item">Поликарбонат</h3>
                        <span class="img__item"><img src="{{ asset('images/dest/catph_mp/cat_photo1.jpg') }}" alt=""></span>
                    </a>
                    <a href="#" class="item__catalog">
                        <h3 class="title__item">Ворота <br>и калитки</h3>
                        <span class="img__item"><img src="{{ asset('images/dest/catph_mp/cat_photo2.jpg') }}" alt=""></span>
                    </a>
                    <a href="#" class="item__catalog">
                        <h3 class="title__item">Охранные <br>ограждения</h3>
                        <span class="img__item"><img src="{{ asset('images/dest/catph_mp/cat_photo3.jpg') }}" alt=""></span>
                    </a>
                    <a href="#" class="item__catalog">
                        <h3 class="title__item">Сетка рабица</h3>
                        <span class="img__item"><img src="{{ asset('images/dest/catph_mp/cat_photo4.jpg') }}" alt=""></span>
                    </a>
                </div>
            </div>
        </section>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="slide__slider">
                                ...
                                <div class="bg_img__slide"><img src="{{ asset('images/dest/assets/slider_second_mp.jpg') }}" alt=""></div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="slide__slider">
            ...
            <div data-wow-delay="0.5s" class="inner wow slideInBottomMy">
                ...
                <div class="catalog__products">
                    <a href="#" class="item__catalog big_item__catalog">
                        <div class="img__item">
                            <img src="{{ asset('images/dest/prodph_mp/prod1.jpg') }}" alt="">
                        </div>
                        <div class="bot__item">
                            <h3 class="title__bot">Ворота и калитка «Фазенда»</h3>
                            <div class="prices__bot">
                                <div class="wrap__prices">
                                    <div class="no_sale__prices">120 790 ₽</div>
                                </div>
                            </div>
                        </div>
                    </a>
                    <a href="#" class="item__catalog">
                        <div class="top__item">
                            <div class="sales__top">
                                <!-- can be more then 1 -->
                                <div class="item__label">-20%</div>
                            </div>
                        </div>
                        <div class="img__item">
                            <img src="{{ asset('images/dest/prodph_mp/prod2.jpg') }}" alt="">
                        </div>
                        <div class="bot__item">
                            <h3 class="title__bot">Сетка сварная с ПВХ покрытием 1,5х15 м ячейка 50х100 мм</h3>
                            <div class="prices__bot">
                                <div class="wrap__prices">
                                    <div class="no_sale__prices">90 765 ₽</div>
                                    <div class="with_sale__prices">150 230 ₽</div>
                                </div>
                            </div>
                        </div>
                    </a>
                    <a href="#" class="item__catalog">
                        <div class="img__item">
                            <img src="{{ asset('images/dest/prodph_mp/prod3.jpg') }}" alt="">
                        </div>
                        <div class="bot__item">
                            <h3 class="title__bot">Сетка сварная оцинкованная ячейка 50х100 мм</h3>
                            <div class="prices__bot">
                                <div class="wrap__prices">
                                    <div class="no_sale__prices">90 765 ₽</div>
                                </div>
                    ...
                    <a href="#" class="item__catalog">
                        ...
                        <div class="img__item">
                            <img src="{{ asset('images/dest/prodph_mp/prod4.jpg') }}" alt="">
                        </div>
                        <div class="bot__item">
                            <h3 class="title__bot">Проволока оцинкованная d2 мм бухта 100 м</h3>
                            <div class="prices__bot">
                                <div class="wrap__prices">
                                    <div class="no_sale__prices">90 765 ₽</div>
                                    <div class="with_sale__prices">150 230 ₽</div>
                    ...
                    <a href="#" class="item__catalog">
                        ...
                        <div class="img__item">
                            <img src="{{ asset('images/dest/prodph_mp/prod5.jpg') }}" alt="">
                        </div>
                        <div class="bot__item">
                            <h3 class="title__bot">Заглушка пластиковая для столба 50×50 мм</h3>
                            <div class="prices__bot">
                                <div class="wrap__prices">
                                    <div class="no_sale__prices">90 765 ₽</div>
                                </div>
                    ...
                    <a href="#" class="item__catalog">
                        <div class="img__item">
                            <img src="{{ asset('images/dest/prodph_mp/prod6.jpg') }}" alt="">
                        </div>
                        <div class="bot__item">
                            <h3 class="title__bot">Проволока оцинкованная с полимерным покрытием</h3>
                            <div class="prices__bot">
                                <div class="wrap__prices">
                                    <div class="no_sale__prices">90 765 ₽</div>
                                </div>
                    ...
                    <a href="#" class="item__catalog">
                        ...
                        <div class="img__item">
                            <img src="{{ asset('images/dest/prodph_mp/prod7.jpg') }}" alt="">
                        </div>
                        <div class="bot__item">
                            <h3 class="title__bot">Калитка с панелью 3D и 2 столбами 1000х1900 мм</h3>
                            <div class="prices__bot">
                                <div class="wrap__prices">
                                    <div class="no_sale__prices">90 765 ₽</div>
                                    <div class="with_sale__prices">150 230 ₽</div>
                    ...
                    <a href="#" class="item__catalog">
                        <div class="img__item">
                            <img src="{{ asset('images/dest/prodph_mp/prod8.jpg') }}" alt="">
                        </div>
                        <div class="bot__item">
                            <h3 class="title__bot">Проволока колючая одноосная d2 мм бухта 100м оцинкованная</h3>
                            <div class="prices__bot">
                                <div class="wrap__prices">
                                    <div class="no_sale__prices">90 765 ₽</div>
                                </div>
                    ...
                    <a href="#" class="item__catalog">
                        ...
                        <div class="img__item">
                            <img src="{{ asset('images/dest/prodph_mp/prod9.jpg') }}" alt="">
                        </div>
                        <div class="bot__item">
                            <h3 class="title__bot">Крепление сетки/секции заборной к столбам 50х50 мм</h3>
                            <div class="prices__bot">
                                <div class="wrap__prices">
                                    <div class="no_sale__prices">90 765 ₽</div>
                                </div>
                    ...
                    <a href="#" class="item__catalog big_item__catalog">
                        ...
                        <div class="img__item">
                            <img src="{{ asset('images/dest/prodph_mp/prod10.jpg') }}" alt="">
                        </div>
                        <div class="bot__item">
                            <h3 class="title__bot">Столб для забора 50х50х1,5 мм 3 м</h3>
                            <div class="prices__bot">
                                <div class="wrap__prices">
                                    <div class="no_sale__prices">120 790 ₽</div>
                                    <div class="with_sale__prices">150 230 ₽</div>
                ...
                <div class="bot__main">
                    ...
                    <div class="payment__bot">
                        <div class="item__payment">
                            <a href="#">
                                <img class="hover__item" src="{{ asset('images/icons/visa_ico.svg') }}" alt="">
                                <img src="{{ asset('images/icons/visa_grey_ico.svg') }}" alt="">
                            </a>
                        </div>
                        <div class="item__payment">
                            <a href="#">
                                <img class="hover__item" src="{{ asset('images/icons/visa_electron_ico.svg') }}" alt="">
                                <img src="{{ asset('images/icons/visa_electron_grey_ico.svg') }}" alt="">
                            </a>
                        </div>
                        <div class="item__payment">
                            <a href="#">
                                <img class="hover__item" src="{{ asset('images/icons/mastercard_ico.svg') }}" alt="">
                                <img src="{{ asset('images/icons/mastercard_grey_ico.svg') }}" alt="">
                            </a>
                        </div>
                        <div class="item__payment">
                            <a href="#">
                                <img class="hover__item" src="{{ asset('images/icons/maestro_ico.svg') }}" alt="">
                                <img src="{{ asset('images/icons/maestro_grey_ico.svg') }}" alt="">
                            </a>
                        </div>
                    </div>
...
<script src="{{ asset('/js/lib/jquery.arcticmodal.js') }}"></script>
<script src="{{ asset('/js/lib/jquery.maskedinput.min.js') }}"></script>
<script src="{{ asset('/js/lib/jquery.nice-select.js') }}"></script>
<script src="{{ asset('/js/lib/swiper-bundle.js') }}"></script>
